      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-muted-foreground text-lg md:text-xl">Имате въпроси? Свържете се с екипа на EOS Matrix Bulgaria</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="glass-card rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 group hover:-translate-y-2 border-border">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl mb-3 text-foreground">Телефон</h3>
                  <a 
            ...
            <div className="glass-card rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 group hover:-translate-y-2 border-border">
              <div className="flex flex-col items-center text-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl mb-3 text-foreground">Адрес</h3>
          ...
          {/* Business Hours Card */}
          <div className="glass-card rounded-3xl p-8 border-border text-center max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
            <h3 className="font-bold text-xl mb-4 text-foreground">Работно време:</h3>
